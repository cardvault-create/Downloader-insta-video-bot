...
async def download(client, message):
    ...
    try:
        ...
        try:
            ...
            await status.edit_text("❌ Failed to fetch! Private or invalid link.")
            return
